    ...
    <>
      ...
      <div className="grid gap-5 xl:grid-cols-[1fr_1fr]">
        <Card className="space-y-4">
          ...
          <div className="space-y-3">
            {snapshot.vatRules.map((rule) => (
              <div key={rule.id} className="rounded-2xl bg-[var(--color-panel)] p-4 text-sm">
        ...
        <Card className="space-y-4">
          ...
          <div className="space-y-3">
            {snapshot.templates.map((template) => (
              <div key={template.id} className="rounded-2xl bg-[var(--color-panel)] p-4 text-sm">
        ...
        <Card className="space-y-4">
          ...
          <div className="rounded-2xl bg-[var(--color-panel)] p-4 text-sm leading-7 text-[var(--color-muted-foreground)]">
