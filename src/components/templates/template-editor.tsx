...
const sampleRows: ReviewRow[] = [
  {
    ...
    bankTransactionAmount: 42.6,
    gross: 42.6,
    grossDifference: 0,
    grossComparisonStatus: "exact",
    net: 35.5,
    vat: 7.1,
    vatPercent: 20,
    vatCode: "GB20",
  ...
  },
  {
    ...
    bankTransactionAmount: 91.12,
    gross: 90.02,
    grossDifference: 1.1,
    grossComparisonStatus: "close",
    grossInRunCurrency: 71.5,
    netInRunCurrency: 71.5,
    vatInRunCurrency: 0,
    fxRate: 1.27,
    net: 90.02,
    vat: 0,
