...
const SEED_CATEGORIES: SeedCategory[] = [
  ...
  { category: "Phone", slug: "phone", description: "Business phone, mobile, and handset-related costs. 50% allowed for mixed personal/business use by default.", section: "Office & Admin", priority: 85, accountType: "expense", statementType: "p_and_l", reportingBucket: "Office & Admin", defaultTaxTreatment: "standard_rated", defaultVatRate: 20, glCode: "6140", allowableForTax: true, allowablePercentage: 50 },
...
function makeCategory(seed: SeedCategory, index: number): CategoryRule {
  ...
  return {
    ...
    isActive: visible,
    isVisible: visible,
    allowableForTax: seed.allowableForTax ?? true,
