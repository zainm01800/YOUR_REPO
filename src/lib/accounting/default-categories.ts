...
const SEED_CATEGORIES: SeedCategory[] = [
  ...
  { category: "Lesson Income", slug: "lesson-income", description: "Tuition or lesson income for training-led businesses. VAT-exempt under HMRC Group 6 (education supplied by an eligible body).", section: "Income", priority: 12, accountType: "income", statementType: "p_and_l", reportingBucket: "Income", defaultTaxTreatment: "exempt", defaultVatRate: 0, defaultVatRecoverable: false, glCode: "4020", keywordPattern: "lesson|tuition|instruction|student|pupil" },
