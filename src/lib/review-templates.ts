...
export const defaultReviewColumns: ReviewGridColumnLayout[] = [
  ...
  { key: "bankStatement",label: "Bank Source",    visible: false, width: 18 },
  ...
  { key: "bankAmount",   label: "Bank Amount",    visible: true,  width: 14 },
  { key: "originalValue",label: "Original Value", visible: true,  width: 14 },
  { key: "gross",        label: "Gross",          visible: true,  width: 12 },
  { key: "difference",   label: "Difference",     visible: true,  width: 12 },
  { key: "grossMatch",   label: "Gross Match",    visible: true,  width: 14 },
  ...
  { key: "matchStatus",    label: "Match Status",    visible: true, width: 14 },
